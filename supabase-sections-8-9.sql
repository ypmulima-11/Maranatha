...
-- 9) PHASES 3 + 5 — events & RSVP, announcements, invites, member approval (status) flow.
-- NOTE: re-running this section also upgrades an OLD database to the new profile columns and role list.
...
-- 9f) ANNOUNCEMENTS — bilingual, everyone active can read, admins and leaders post.
